...
contract CrowdSale {
    ...
    constructor(
        ...
        uint _fundingMaximumTargetInEther,
        MassToken _addressOfTokenUsedAsReward,
        uint _CostOfEachTokenInWei) public
    {
        creator = msg.sender;
        ...
        currentBalance = 0;
        tokenReward = MassToken(_addressOfTokenUsedAsReward);
